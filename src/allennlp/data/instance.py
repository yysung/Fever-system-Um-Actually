...
token_to_index= pickle.load(open('./token_to_index.pkl','rb'))
index_to_token= pickle.load(open('./index_to_token.pkl','rb'))
...
class Instance:
    ...
    def index_fields(self, vocab: Vocabulary):
        ...
        ``Vocabulary``.  This `mutates` the current object, it does not return a new ``Instance``.
        """
        #token_to_index = copy.deepcopy(vocab._token_to_index["tokens"])
        #index_to_token = copy.deepcopy(vocab._index_to_token["tokens"])
        ...
        #pdb.set_trace()
        for field in self.fields.values():
            #vocab._token_to_index["tokens"] = token_to_index
            #vocab._index_to_token["tokens"] = index_to_token
            field.index(vocab)
