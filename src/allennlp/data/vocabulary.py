...
class Vocabulary:
    ...
    def get_index_to_token_vocabulary(self, namespace: str = 'tokens') -> Dict[int, str]:
        self._index_to_token[namespace]= index_to_token
    ...
    def get_token_index(self, token: str, namespace: str = 'tokens') -> int:
        if token in self._token_to_index[namespace]:
            ...
            #pdb.set_trace()
            self._token_to_index[namespace] = token_to_index
           # if self._oov_token == '@@UNKNOWN@@':
                        #self._token_to_index[namespace]['@@UNKNOWN@@'] = len(self._token_to_index[namespace]) 
